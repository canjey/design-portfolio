            ...
            <BrowserRouter>
                <Grid container>
                    <Grid item lg={6} xl={6} md={5.5} sx={{ display: { xs: 'none', md: 'inline', marginLeft: { xs: '10px' } } }}>
                        <img src="Ellipse.png" width="100px" />
                    </Grid>
                    ...
                    <Grid item xl={1.3} md={1.5} sm={3} xs={4} sx={{ marginTop: '3%' }}>
                        <Link href="#myservices" style={{ textDecoration: 'none' }}>
                            <Button variant="text" onClick={handleServiceClick} style={{ color: services ? "#F900D1" : "white", width: '120px' }}>About Me</Button>
                        </Link>
                    </Grid>
                    <Grid item xl={1.3} md={1.5} sm={3} xs={4} sx={{ marginTop: '3%' }}>
                        <Link href="#myservices" style={{ textDecoration: 'none' }}>
                            <Button variant="text" onClick={handleServiceClick} style={{ color: services ? "#F900D1" : "white", width: '120px' }}>Services</Button>
                        </Link>
                    </Grid>
